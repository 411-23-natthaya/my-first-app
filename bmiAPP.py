...
weight = st.number_input("กรอกน้ำหนักของคุณ (กิโลกรัม):",min_value=0.1, value=1.0)
height_cm = st.number_input("กรอกส่วนสูงของคุณ (เซนติเมตร):",min_value=0.1, value=1.0)
...
st.divider()
st.write("น.ส.ณัฐธยาน์ สิงห์โต เลขที่ 23 ม.4/11")
